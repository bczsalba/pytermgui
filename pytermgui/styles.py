from . import set_style, color, gradient, bold, italic, strikethrough, underline, highlight, get_gradient
...
def draculite():
    ...
    set_style('container_border',lambda depth,item: bold(color(item,get_gradient(60)[depth])))
